...
class Instruction {
	public:
		//CONSTRUCTORS
		Instruction() :
		variety(NO_INSTRUCTION), facing(NO_DIRECTION), rotation(NO_ROTATION), active(true) {};
		
		Instruction(InstructionClass v) :
		variety(v), facing(NO_DIRECTION), rotation(NO_ROTATION), active(true) {};
		
		Instruction(InstructionClass v, Direction d) :
		variety(v), facing(d), rotation(NO_ROTATION), active(true) {};
		
		Instruction(InstructionClass v, Rotation r) :
		variety(v), facing(NO_DIRECTION), rotation(r), active(true) {};
		
		Instruction(InstructionClass v, Direction d, Rotation r) :
		variety(v), facing(d), rotation(r), active(true) {};
